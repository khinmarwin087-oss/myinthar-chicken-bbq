    ...
    />
        ...
        <div style={{ background: '#F2F2F7', minHeight: '100vh', padding: '15px', fontFamily: 'sans-serif' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                ...
                <button onClick={() => { setShowForm(!showForm); setEditId(null); setFormData({name:'', price:'', stock:'', category:'', image:''}); }} style={{ background: '#007AFF', color: 'white', border: 'none', padding: '10px 18px', borderRadius: '12px', fontWeight: '700' }}>
